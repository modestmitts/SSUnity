        ...
        public override void OnSubInspectorGUI()
        {
            ...
            if (TargetItem != null)
            {
                ...
                else
                {
                    ...
                    TargetItem.IconOrientation = EditorGUILayout.Vector3Field(new GUIContent("Icon Orientation", "The initial angle that this 3D icon will appear within an inventory slot."),
