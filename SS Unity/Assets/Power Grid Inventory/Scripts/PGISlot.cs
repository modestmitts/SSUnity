...
namespace PowerGridInventory
{
    ...
    [AddComponentMenu("Power Grid Inventory/PGI Inventory Slot", 13)]
    [Serializable]
    ...
    IPointerClickHandler
    {
        ...
        public int StackCount
        {
            protected set
            {
                if (LastStackCount != value)
                {
                    ...
                    if (LastStackCount < 2)
                    {
                        this.StackSize.text = null;
                        StackSize.enabled = false;
                    }
                    else
                    {
                        this.StackSize.text = value.ToString();
        ...
        protected virtual void Awake()
        {
            ...
            if (IconMesh == null) throw new UnityException("You must supply a gameobject with a PowerGridInventory.CanvasMesh component attached to the 'IconMesh' child object of each Grid Slot");
            ...
            //may longer be children due to the batching system used by the PGIView.
        ...
        protected virtual void Start()
        {
            ...
            if (Canvas == null)
            {
                throw new UnityException("This GridSlot must have a parent somewhere in its heirarchy that has a Canvas attached to it.");
            }
        ...
        //TODO: This should probably be moved to the PGIView and handled when checking for dirty regions.
        ...
        void OnEnable()
        {
            ...
            else if (Item != null)
            {
                ...
                //if (Item.IconType == PGISlotItem.IconAssetType.Mesh) IconMesh.UpdateView();
            }
        ...
        public virtual void AssignItem(PGISlotItem item, bool setIcon = true)
        {
            ...
            if (Item == null)
            {
                if (!Blocked) this.HighlightColor = this.View.NormalColor;
                SetDefaultIcon();
            }
            else
            {
                ...
                //fallback incase we are somehow missing a sprite *and* a mesh for this item's icon.
                else SetDefaultIcon();
                        ...
                        case PGISlotItem.RotateDirection.None:
                            {
                                ...
                                IconMesh.transform.eulerAngles = Vector3.zero;
                                Highlight.transform.eulerAngles = Vector3.zero;
                                break;
                            }
                        case PGISlotItem.RotateDirection.CW:
                            {
                                IconImage.transform.eulerAngles = new Vector3(0.0f, 0.0f, 270.0f);
                                IconMesh.transform.eulerAngles = new Vector3(0.0f, 0.0f, 270.0f);
                                Highlight.transform.eulerAngles = new Vector3(0.0f, 0.0f, 270.0f);
                                break;
                            }
                        case PGISlotItem.RotateDirection.CCW:
                            {
                                IconImage.transform.eulerAngles = new Vector3(0.0f, 0.0f, 90.0f);
                                IconMesh.transform.eulerAngles = new Vector3(0.0f, 0.0f, 90.0f);
                                Highlight.transform.eulerAngles = new Vector3(0.0f, 0.0f, 90.0f);
                                break;
                            }
                        default:
                            {
        ...
        {
            if (Item == null) this.HighlightColor = defaultViewColor;
            else if (this.Blocked) this.HighlightColor = this.View.BlockedColor;
            else this.HighlightColor = Item.Highlight;
        }
        ...
        public void UpdateSlotSize()
        {
            ...
            foreach (var element in BatchedElements)
            {
                ...
                {
                    var newParent = element.transform.parent;
                    ...
                    element.Rect.SetParent(newParent, true);
                }
            }
        }
        #endregion
